...
namespace GameSpace
{
    public partial class LodeRunner
    {
      ...
      */		
      ...
      public void setClassicInfo(passed)
      {
      ...
      public void clearClassicInfo()
      {
        clearStorage(STORAGE_CLASSIC_INFO + playData);
      }

      public void getModernInfo()
      {
        var infoJSON;
      ...
      public void getModernScoreInfo()
      {
      ...
      public void setModernScoreInfo()
      {
      ...
      public bool delEditLevel(level) 
      {
      ...
      public bool addEditLevel(levelMap) 
      {
      ...
      public void clearEditLevelInfo()
      {
        clearStorage(STORAGE_EDIT_INFO);
      }

      public void initNewLevelInfo(testInfo)
      {
      ...
      public int compareWithExist(existLevelMap, testLevelMap)
      {
        for(var i = 0; i < NO_OF_TILES_X * NO_OF_TILES_Y; i++) {
      ...
      public void getTestLevel(testInfo)
      {
        var infoJSON;
      ...
      public void setTestLevel(testInfo)
      {
      ...
      public void createUserDefaultLevel()
      {
      ...
      public void setThemeMode(themeName)
      {
      ...
      // for debug only 
      //=========================
      public void genUserLevel(levels)
      {
        var levelMap = 
          "                    H       " +
          "                   &H       " +
      ...
      //=======================================
      public void setStorage(key, value) 
      {
