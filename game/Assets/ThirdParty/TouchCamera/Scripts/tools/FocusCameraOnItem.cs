...
namespace BitBenderGames
{
  ...
  public class FocusCameraOnItem : MonoBehaviourWrapped
  {
    ...
    private void Awake()
    {
      ...
      MobileTouchCamera.OnStopScrolling += StopScrolling;
    ...
    public void FocusCameraOnTarget(Vector3 targetPosition, float zoom)
    {
      FocusCameraOnTarget(targetPosition, Transform.rotation, Mathf.Clamp(zoom, MobileTouchCamera.CamZoomMin, MobileTouchCamera.CamZoomMax));
    }
